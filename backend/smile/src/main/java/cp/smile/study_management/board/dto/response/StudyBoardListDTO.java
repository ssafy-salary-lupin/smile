...
public class StudyBoardListDTO {
    ...
    private List<BoardDTO> studyBoards;

    public static StudyBoardListDTO of(List<StudyBoard> boards) {
        List<BoardDTO> list = boards.stream().map(BoardDTO::of).collect(Collectors.toList());

        StudyBoardListDTO dto = new StudyBoardListDTO();
        dto.studyBoards = list;
        return dto;
    }
    ...
    private static class BoardDTO {
        ...
        private static BoardDTO of(StudyBoard board) {
